...
1. Go to Recovery
2. Make sure you are on F.05(RUI4) Firmware using this guide: https://graph.org/Guide-To-Flash-ROMs-Based-On-RUI4-RMX3031-03-02
3. Flash Rom
...
ROM based on F.05 firmware so make sure u are on the F.05 firmware
